...
echo "  ./control.sh cal col-left      # Calendar: Vertical Column Left (or: col-right)"
echo "  ./control.sh sys katana        # System Identity: Katana slash"
echo "  ./control.sh st stats          # System Stats: Start stats widget"
