...
echo "  ./control.sh twk-- clo 12h-h   # Clock: 12-Hour Horizontal (Default)"
echo "  ./control.sh twk-- clo 12h-v   # Clock: 12-Hour Vertical (Stacked)"
echo "  ./control.sh twk-- clo 24h-h   # Clock: 24-Hour Horizontal (Inline)"
echo "  ./control.sh twk-- clo 24h-v   # Clock: 24-Hour Vertical (Stacked)"
echo "  ./control.sh twk-- cal grid    # Calendar: 7-Day Row Grid (Default)"
echo "  ./control.sh twk-- cal col     # Calendar: Vertical Column (01..31)"
